    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PossibleDateSet', to='countries.country')),
            ],
        ),
        migrations.CreateModel(
            name='ModelDateRange',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='KnotPointSet', to='countries.country')),
            ],
        ),
    ]
